package id.interview.newsapi.view.listcategory.entertainment
...
class EntertainmentActivity : BaseActivity(), ViewNetworkState, IView, CategoryAdapter.onClickListener {
