...
public class Global {
    public static final String API_URL = "http://flix.exscose.com/api/";
    public static final String SECURE_KEY = "4F5A9C3D9A86FA54EACEDDD635185";
    public static final String Youtube_Key = "AIzaSyDUCYux_EPOCy0nWeYNGaPOhFDHnU2v898";
    // get it from this link  https://console.developers.google.com/apis/credentials
